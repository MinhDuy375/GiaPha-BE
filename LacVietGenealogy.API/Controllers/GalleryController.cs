...
public class GalleryController : ControllerBase
{
    ...
    public async Task<IActionResult> Upload(IFormFile file, [FromForm] string? caption, [FromForm] string? notes, [FromForm] Guid? memberId)
    {
        ...
        var image = new GalleryImage { Id = id, FamilyTreeId = treeId, MemberId = memberId, FileName = file.FileName, FileUrl = $"/{folder.Replace('\\', '/')}/{fileName}", Caption = caption, Notes = notes };
