...
{
    /// <inheritdoc />
    public partial class AddFamilyGallery : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GalleryImages_FamilyTrees_FamilyTreeId",
                        column: x => x.FamilyTreeId,
                        principalTable: "FamilyTrees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GalleryImages_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryImages_FamilyTreeId",
                table: "GalleryImages",
                column: "FamilyTreeId");

            migrationBuilder.CreateIndex(
                name: "IX_GalleryImages_MemberId",
                table: "GalleryImages",
                column: "MemberId");
        }
